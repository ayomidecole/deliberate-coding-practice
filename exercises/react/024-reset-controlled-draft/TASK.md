...
```bash
npx vitest run exercises/react/024-reset-controlled-draft
```
...
```bash
npm run typecheck
npx vite build exercises/react/024-reset-controlled-draft
...
```bash
npx vite exercises/react/024-reset-controlled-draft --host 127.0.0.1
```
