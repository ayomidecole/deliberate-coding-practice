...
```bash
npx vitest run exercises/react/029-derive-available-inventory
```
...
npx vitest run exercises/react/029-derive-available-inventory
npm run typecheck
npx vite build exercises/react/029-derive-available-inventory
...
```bash
npx vite exercises/react/029-derive-available-inventory --host 127.0.0.1
```
