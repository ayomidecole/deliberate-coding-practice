...
```bash
npx vitest run exercises/react/021-mount-app-in-browser
```
...
```bash
npm run typecheck
npx vite build exercises/react/021-mount-app-in-browser
...
```bash
npx vite exercises/react/021-mount-app-in-browser --host 127.0.0.1
```
