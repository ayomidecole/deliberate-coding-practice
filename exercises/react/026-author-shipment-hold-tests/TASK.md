...
```bash
npx vitest run exercises/react/026-author-shipment-hold-tests
```
...
```bash
npm run typecheck
npx vite build exercises/react/026-author-shipment-hold-tests
...
```bash
npx vite exercises/react/026-author-shipment-hold-tests --host 127.0.0.1
```
