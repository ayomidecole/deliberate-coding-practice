...
```bash
npm run typecheck
npx vitest run exercises/react/042-integrate-stateful-incident-review/src/types
npx vitest run exercises/react/042-integrate-stateful-incident-review/src/domain
npx vitest run exercises/react/042-integrate-stateful-incident-review/src/components
npx vitest run exercises/react/042-integrate-stateful-incident-review/src/features
```
...
```bash
npm run typecheck
npx vitest run exercises/react/042-integrate-stateful-incident-review
npx vite build exercises/react/042-integrate-stateful-incident-review
...
```bash
npx vite exercises/react/042-integrate-stateful-incident-review --host 127.0.0.1d
