...
function renderFeature() {
    ...
    render(<ReviewReleaseGatesFeature gates={gates} minimumApprovals={2} />);
}
...
describe('ReviewReleaseGatesFeature', () => {
    ...
    it('only shows gates requiring at least 2 approvals', () => {
        renderFeature();
        ...
        expect(screen.getByText('release-engineering')).toBeTruthy();
        expect(screen.getByText('incident-command')).toBeTruthy();
    });
});
