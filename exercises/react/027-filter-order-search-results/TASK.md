...
```bash
npx vitest run exercises/react/027-filter-order-search-results
```
...
```bash
npm run typecheck
npx vite build exercises/react/027-filter-order-search-results
...
```bash
npx vite exercises/react/027-filter-order-search-results --host 127.0.0.1
```
