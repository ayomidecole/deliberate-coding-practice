...
```bash
npx vitest run exercises/react/01-fundamentals/028-filter-delayed-shipments
```
...
```bash
npm run typecheck
npx vite build exercises/react/01-fundamentals/028-filter-delayed-shipments
...
```bash
npx vite exercises/react/01-fundamentals/028-filter-delayed-shipments --host 127.0.0.1
```
