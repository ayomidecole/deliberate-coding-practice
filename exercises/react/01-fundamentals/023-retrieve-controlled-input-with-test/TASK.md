...
```bash
npx vitest run exercises/react/01-fundamentals/023-retrieve-controlled-input-with-test
```
...
```bash
npm run typecheck
npx vite build exercises/react/01-fundamentals/023-retrieve-controlled-input-with-test
...
```bash
npx vite exercises/react/01-fundamentals/023-retrieve-controlled-input-with-test --host 127.0.0.1
```
