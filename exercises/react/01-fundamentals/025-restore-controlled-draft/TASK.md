...
```bash
npx vitest run exercises/react/01-fundamentals/025-restore-controlled-draft
```
...
```bash
npm run typecheck
npx vite build exercises/react/01-fundamentals/025-restore-controlled-draft
...
```bash
npx vite exercises/react/01-fundamentals/025-restore-controlled-draft --host 127.0.0.1
```
