...
```bash
npx vitest run exercises/react/01-fundamentals/022-control-order-search-input
```
...
```bash
npm run typecheck
npx vite build exercises/react/01-fundamentals/022-control-order-search-input
...
```bash
npx vite exercises/react/01-fundamentals/022-control-order-search-input --host 127.0.0.1
```
