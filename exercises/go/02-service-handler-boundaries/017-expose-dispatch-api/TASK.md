...
```sh
go test ./exercises/go/02-service-handler-boundaries/017-expose-dispatch-api -v
```

Before review:

```sh
gofmt -w exercises/go/02-service-handler-boundaries/017-expose-dispatch-api
npm run check:go
```
