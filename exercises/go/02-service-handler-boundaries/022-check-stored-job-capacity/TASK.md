...
```sh
go test ./exercises/go/02-service-handler-boundaries/022-check-stored-job-capacity -v
```
...
```sh
gofmt -w exercises/go/02-service-handler-boundaries/022-check-stored-job-capacity
npm run check:go
```
