...
```sh
go test ./exercises/go/02-service-handler-boundaries/026-test-order-benefits-service/... -v
```

Before requesting review:

```sh
gofmt -w exercises/go/02-service-handler-boundaries/026-test-order-benefits-service
npm run check:go
```
