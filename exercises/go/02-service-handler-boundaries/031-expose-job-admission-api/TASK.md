...
```sh
go test ./exercises/go/02-service-handler-boundaries/031-expose-job-admission-api/... -v
```

Before review:

```sh
gofmt -w exercises/go/02-service-handler-boundaries/031-expose-job-admission-api
npm run check:go
```
