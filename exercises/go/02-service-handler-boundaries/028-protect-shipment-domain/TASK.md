...
```sh
go test ./exercises/go/02-service-handler-boundaries/028-protect-shipment-domain/... -v
```

Before review:

```sh
gofmt -w exercises/go/02-service-handler-boundaries/028-protect-shipment-domain
npm run check:go
```
