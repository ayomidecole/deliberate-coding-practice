...
```sh
go test ./exercises/go/01-foundations-testing/015-calculate-worker-pool-availability -v
```

Before review:

```sh
gofmt -w exercises/go/01-foundations-testing/015-calculate-worker-pool-availability
npm run check:go
```
