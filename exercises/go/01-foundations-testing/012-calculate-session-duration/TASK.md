...
```sh
go test ./exercises/go/01-foundations-testing/012-calculate-session-duration -v
```

Before review:

```sh
gofmt -w exercises/go/01-foundations-testing/012-calculate-session-duration
npm run check:go
```
