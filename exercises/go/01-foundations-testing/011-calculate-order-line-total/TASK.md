...
```sh
go test ./exercises/go/01-foundations-testing/011-calculate-order-line-total -v
```

Before review:

```sh
gofmt -w exercises/go/01-foundations-testing/011-calculate-order-line-total
npm run check:go
```
